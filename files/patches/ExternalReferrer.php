...
class SearchEngines
{
    ...
    /** search keyword highlighting is causing PHP runtime exceptions in phpwiki-1.5.0
        that are not worth trying to fix. 
        Disabling ENABLE_SEARCHHIGHLIGHT in config.ini causes OOM erros.
        So disbable by emptying array.
        - Mark 22 April 2015
        - Redmine #19276
    **/
